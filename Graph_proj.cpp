...
Tagged_image::Tagged_image(Point xy, string s, Suffix::Encoding e)
    :Image(xy, s, e), w(0), h(0), fn(xy,"")
{
    add(xy);
	filename = s;
    if (!can_open(s)) {    // can we open s?
...
void Tagged_image::draw_lines() const
{
    if (fn.label()!="") fn.draw_lines();
...
/* Functions to change tag bool values */

void Tagged_image::family_val(bool family_in) {family = family_in;}

void Tagged_image::friends_val(bool friends_in) {friends = friends_in;}

void Tagged_image::aggieland_val(bool aggieland_in) {aggieland = aggieland_in;}

void Tagged_image::pets_val(bool pets_in) {pets = pets_in;}

void Tagged_image::vacation_val(bool vacation_in) {vacation = vacation_in;}

//------------------------------------------------------------------------------ 

/* Functions to check and return tag bool values */

bool Tagged_image::family_check() {return family;}

bool Tagged_image::friends_check() {return friends;}

bool Tagged_image::aggieland_check() {return aggieland;}

bool Tagged_image::pets_check() {return pets;}

bool Tagged_image::vacation_check() {return vacation;}

//------------------------------------------------------------------------------ 

string Tagged_image::file_name() {return filename;}
